...
TRANSLATIONS = {
    'en': {
        ...
        'what_they_owe_you_subtext': 'Money you are owed',
        'what_you_owe': 'What You Owe',
        'what_you_owe_subtext': 'Money you owe others',
        'money_in_subtext': 'Money received',
        'money_out_subtext': 'Money paid out',
        'your_goods_stock': 'Goods & Stock',
        'goods_stock_subtext': 'Your goods and stock',
        'wallet_subtext': 'In-app currency',
        'reports_subtext': 'Business reports',
        'download_pdf': 'PDF',
        'share': 'Share',
    ...
    'ha': {
        'home': 'Gida',
        'hello_user': 'Sannu',
        'welcome_back': 'Sannu da dawowa zuwa Ficore Records',
        'i_owe': 'Ina bin bashi',
        'i_am_owed': 'Ana bin ni bashi',
        'net_position': 'Matsayin Net',
        ...
        'add_new_creditor': 'Ƙara Sabon Mai Bashi',
        'add_new_debtor': 'Ƙara Sabon Mai Bin Bashi',
        'add_new_debt': 'Ƙara Sabon Bashi',
        'money_in': 'Kuɗi Shigo',
        'money_out': 'Kuɗi Fita',
        'add_inventory': 'Ƙara Kayan Ajiya',
        'recent_activity': 'Ayyukan Kwanan Nan',
        'view_all': 'Duba Duk',
        'loading_activities': 'Ana loda ayyukan kwanan nan...',
        'just_now': 'Yanzu',
        'explore_features': 'Bincika Abubuwan Fasali',
        'admin_dashboard': 'Dashboard na Admin',
        'admin_dashboard_desc': 'Sarrafa masu amfani da saituna',
        'reports': 'Rahotanni',
        'reports_desc': 'Bayanan kasuwanci',
        'your_wallet': 'Jakar Kuɗin ku',
        'wallet_desc': 'Sarrafa tsabar kuɗi',
        'cashflow_analysis': 'Kwararar Kuɗi',
        'cashflow_desc': 'Bin diddigin kwararar kuɗi',
        'inventory_management': 'Gudanar da Kaya',
        'inventory_desc': 'Gudanar da haja',
        'feedback': 'Ra’ayi',
        'feedback_desc': 'Raba ra’ayoyinku',
        'welcome': 'Maraba da zuwa Ficore Records',
        'welcome_desc': 'Ficore Records yana taimaka muku sarrafa masu bin bashi, masu ba da bashi, rasitoci, da biyan kuɗi cikin sauƙi. Sauƙaƙe bin diddigin kuɗaɗenku kuma sami haske game da lafiyar kasuwancinku.',
        'signup': 'Yi Rajista',
        'login': 'Shiga',
        'debts': 'Bashi',
        ...
        'inventory': 'Kaya',
        'profile': 'Profile',
        'owed_to_you': 'Ana bin ku',
        'you_owe': 'Kuna bin bashi',
        ...
        'go_to_your_goods-stock': 'Je zuwa Kayanka da Hajarka',
        ...
        'Password must be at least 8 characters': 'Kalmar Sirri dole ne ya kasance aƙalla 8 haruffa',
        'Email': 'Imel',
        'email': 'Imel',
        ...
        'are_you_sure_delete_transaction': 'Kana da tabbacin kana son share tanks',
