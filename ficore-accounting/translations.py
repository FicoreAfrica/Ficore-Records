...
TRANSLATIONS = {
    'en': {
        ...
        'manage_creditors': 'Manage Creditors',
        'manage_receipts': 'Manage Receipts',
        'manage_payments': 'Manage Payments',
        'manage_inventory': 'Manage Inventory',
        'manage_coins': 'Manage Coins',
        'go_to_admin_dashboard': 'Go to Admin Dashboard',
        'go_to_debtors': 'Go to Debtors',
        'go_to_creditors': 'Go to Creditors',
        'go_to_receipts': 'Go to Receipts',
        'go_to_payments': 'Go to Payments',
        'go_to_inventory': 'Go to Inventory',
        'go_to_reports': 'Go to Reports',
        'go_to_coins': 'Go to Coins',
        'debtors_desc': 'Track who owes you money and manage their payment status.',
        'admin_dashboard_desc': 'Manage users and settings',
        'creditors_desc': 'Keep track of who you owe and manage your outstanding bills.',
        'receipts_desc': 'Record and organize all your incoming payment proofs.',
        'payments_desc': 'Log and categorize all your outgoing expenses and settlements.',
        'inventory_desc': 'Manage your stock levels, product details, and inventory movements.',
        'reports_desc': 'Generate financial reports like Profit & Loss and Inventory summaries.',
        'coins_desc': 'Manage your account balance, purchase history, and upload receipts for coins.',
    ...
    'ha': {
        ...
        'facebook_label': 'Facebook',
        'linkedin_label': 'LinkedIn',
        'debtors_desc': 'Bibiyar waɗanda ke bin ku bashi da sarrafa matsayin biyan su.',
        'creditors_desc': 'Bibiyar waɗanda kuke bin su bashi da sarrafa kuɗin ku na fita.',
        'receipts_desc': 'Yi rikodin da tsara duk takardun shigar ku na biya.',
        'payments_desc': 'Yi rikodin da rarraba duk kuɗin ku na fita da kuma daidaita su.',
        'admin_dashboard_desc': 'Sarrafa masu amfani da saituna',
        'inventory_desc': 'Sarrafa matakan haja, bayanan samfur, da motsin haja.',
        'reports_desc': 'Ƙirƙiri rahotannin kuɗi kamar Ribar & Asara da taƙaitaccen haja.',
        'manage_debtors': 'Sarrafa Masu Bashi',
        'manage_creditors': 'Sarrafa Masu Bin Bashi',
        'manage_receipts': 'Sarrafa Takardun Karɓa',
        'manage_payments': 'Sarrafa Biya',
        'manage_inventory': 'Sarrafa Kaya',
        'manage_coins': 'Sarrafa Tsabar Kuɗi',
        'go_to_admin_dashboard': 'Je zuwa Dashboard na Admin',
        'go_to_debtors': 'Je zuwa Masu Bashi',
        'go_to_creditors': 'Je zuwa Masu Bin Bashi',
        'go_to_receipts': 'Je zuwa Takardun Karɓa',
        'go_to_payments': 'Je zuwa Biya',
        'go_to_inventory': 'Je zuwa Kaya',
        'go_to_reports': 'Je zuwa Rahotanni',
        'go_to_coins': 'Je zuwa Tsabar Kuɗi',
        'view_reports': 'Duba Rahotanni',
        'dark_mode_error':'An kasa kunna juyin kala',
        'coins_desc': 'Sarrafa ma\'aunin asusun ku, tarihin siyayya, kuma ku ɗora takardun biya don tsabar kuɗi.',
        'welcome_desc':'Ficore Records shine matakin inganci wajen kulada masu bin ka bashi, masu binka bashi, kudin dake shigowa, da kuma kuɗi da aka biya, cikin sauƙi.',
